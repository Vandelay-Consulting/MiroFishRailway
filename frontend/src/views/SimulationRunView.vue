    ...
    <header class="app-header">
      ...
      <div class="header-center">
        <div class="view-switcher">
          <button 
            ...
            @click="viewMode = mode"
          >
            {{ { graph: $t('views.graph'), split: $t('views.split'), workbench: $t('views.workbench') }[mode] }}
          </button>
        </div>
      </div>
      ...
      <div class="header-right">
        <div class="workflow-step">
          <span class="step-num">{{ $t('steps.step') }} 3{{ $t('steps.of') }}5</span>
          <span class="step-name">{{ $t('steps.simulation.title') }}</span>
        </div>
...
// Get maxRounds from query params during initialization to ensure child components can get the value immediately
