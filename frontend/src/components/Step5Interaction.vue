    ...
    <div class="main-split-layout">
      ...
      <div class="left-panel report-style" ref="leftPanel">
        <div v-if="reportOutline" class="report-content-wrapper">
          ...
          <div class="report-header-block">
            <div class="report-meta">
              <span class="report-tag">{{ $t('steps.report.tag') }}</span>
            ...
            >
              ...
              <div class="section-body" v-show="!collapsedSections.has(idx)">
                ...
                <div v-else-if="currentSectionIndex === idx + 1" class="loading-state">
                  ...
                  <span class="loading-text">{{ $t('steps.report.generating') }}{{ section.title }}...</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div v-if="!reportOutline" class="waiting-placeholder">
          ...
          <span class="waiting-text">{{ $t('steps.report.waiting') }}</span>
        </div>
      </div>
      ...
      <div class="right-panel" ref="rightPanel">
        ...
        <div class="action-bar-header">
          ...
          <div class="action-bar-text">
            <span class="action-bar-title">{{ $t('steps.interaction.interactiveTools') }}</span>
          ...
          <div class="action-bar-tabs">
            ...
            >
              ...
              <span>{{ $t('steps.interaction.chatWithReportAgent') }}</span>
            </button>
            <div class="agent-dropdown" v-if="profiles.length > 0">
              ...
              >
                ...
                <span>{{ selectedAgent ? selectedAgent.username : $t('steps.interaction.chatWithAgent') }}</span>
                <svg class="dropdown-arrow" :class="{ open: showAgentDropdown }" viewBox="0 0 24 24" width="12" height="12" fill="none" stroke="currentColor" stroke-width="2">
                  <polyline points="6 9 12 15 18 9"></polyline>
                </svg>
              </button>
              <div v-if="showAgentDropdown" class="dropdown-menu">
                <div class="dropdown-header">{{ $t('steps.interaction.selectAgent') }}</div>
                <div 
                ...
                >
                  ...
                  <div class="agent-info">
                    ...
                    <span class="agent-role">{{ agent.profession || $t('steps.interaction.unknownProfession') }}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <span>{{ $t('steps.interaction.sendSurvey') }}</span>
            </button>
          </div>
        </div>
        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-name">{{ $t('steps.interaction.reportAgentChat') }}</div>
              <div class="tools-card-subtitle">{{ $t('steps.interaction.reportAgentDesc') }}</div>
              </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">{{ $t('steps.report.tools.insightForge') }}</div>
                    <div class="tool-desc">{{ $t('steps.report.tools.insightForgeDesc') }}</div>
                  </div>
                </div>
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">{{ $t('steps.report.tools.panoramaSearch') }}</div>
                    <div class="tool-desc">{{ $t('steps.report.tools.panoramaSearchDesc') }}</div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">{{ $t('steps.report.tools.quickSearch') }}</div>
                    <div class="tool-desc">{{ $t('steps.report.tools.quickSearchDesc') }}</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">{{ $t('steps.report.tools.agentSurvey') }}</div>
                    <div class="tool-desc">{{ $t('steps.report.tools.agentSurveyDesc') }}</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div v-if="chatTarget === 'agent' && selectedAgent" class="agent-profile-card">
            <div class="profile-card-header">
              ...
              <div class="profile-card-info">
                ...
                <div class="profile-card-meta">
                  ...
                  <span class="profile-card-profession">{{ selectedAgent.profession || $t('steps.interaction.unknownProfession') }}</span>
                </div>
              </div>
            ...
            <div v-if="showFullProfile && selectedAgent.bio" class="profile-card-body">
              <div class="profile-card-bio">
                <div class="profile-card-label">{{ $t('steps.interaction.profileBio') }}</div>
        ...
        <div v-if="activeTab === 'survey'" class="survey-container">
          ...
          <div class="survey-setup">
            <div class="setup-section">
              <div class="section-header">
                <span class="section-title">{{ $t('steps.interaction.selectSurveyTargets') }}</span>
                <span class="selection-count">{{ $t('steps.interaction.selectedCount', { count: selectedAgents.size, total: profiles.length }) }}</span>
              </div>
              <div class="agents-grid">
                ...
                >
                  ...
                  <div class="checkbox-info">
                    ...
                    <span class="checkbox-role">{{ agent.profession || $t('steps.interaction.unknownProfession') }}</span>
                  </div>
              ...
              <div class="selection-actions">
                <button class="action-link" @click="selectAllAgents">{{ $t('steps.interaction.selectAll') }}</button>
                <span class="action-divider">|</span>
                <button class="action-link" @click="clearAgentSelection">{{ $t('steps.interaction.clearSelection') }}</button>
              </div>
            </div>

            <div class="setup-section">
              <div class="section-header">
                <span class="section-title">{{ $t('steps.interaction.surveyQuestion') }}</span>
              </div>
              <textarea 
            ...
            >
              ...
              <span v-else>{{ $t('steps.interaction.sendSurveyBtn') }}</span>
            </button>
          </div>
          ...
          <div v-if="surveyResults.length > 0" class="survey-results">
            <div class="results-header">
              <span class="results-title">{{ $t('steps.interaction.surveyResults') }}</span>
            ...
            <div class="results-list">
              ...
              >
                ...
                <div class="result-info">
                  ...
                  <span class="result-role">{{ result.profession || $t('steps.interaction.unknownProfession') }}</span>
                </div>
                </div>
...
const renderMarkdown = (content) => {
  ...
  // Clean up <p><br> following block elements (caused by extra blank lines)
  ...
  // Fix numbering for non-consecutive ordered lists: maintain incremental numbering when single-item <ol> are separated by paragraph content
...
const sendToAgent = async (message) => {
  ...
  const res = await interviewAgents({
    ...
    if (typeof resultsDict === 'object' && !Array.isArray(resultsDict)) {
      ...
      // Support array format for compatibility
...
/* Fix ordered list numbering - use CSS counters for consecutive ol numbering */
.message-text {
