...
Reads nodes from Zep knowledge graph and filters nodes that match predefined entity types
"""
...
class ZepEntityReader:
    ...
    def _call_with_retry(
        ...
        Args:
            ...
            max_retries: Maximum retry attempts (default 3, i.e., at most 3 attempts)
    ...
    def filter_defined_entities(
        ...
        Filtering logic：
        - If the node's Labels only has 'Entity', it doesn't match predefined types, skip
        - If the node's Labels contain labels other than 'Entity' and 'Node', it matches predefined types, keep
        ...
        """
        logger.info(f"Starting to filter graph {graph_id} 's entities...")
        ...
        logger.info(
            f"Filtering complete: Total nodes {total_count}, Matching criteria {len(filtered_entities)}, "
