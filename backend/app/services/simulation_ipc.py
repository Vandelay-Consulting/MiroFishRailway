...
class SimulationIPCClient:
    ...
    def send_interview(
        ...
        Args:
            ...
            platform: Specify platform (optional)
                ...
                - None: Interview both platforms in dual-platform simulation, or the single platform
            timeout: Timeout in seconds

        Returns:
            IPCResponse with result field containing interview results
        """
    ...
    def send_batch_interview(
        ...
        Args:
            ...
            platform: Default platform (optional, can be overridden by each interview's platform)
