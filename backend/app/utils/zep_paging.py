...
def fetch_all_nodes(
    ...
    """Paginated retrieval of graph nodes, returning at most max_items items (default 2000). Each page request has built-in retry."""
    all_nodes: list[Any] = []
...
def fetch_all_edges(
    ...
    """Paginated retrieval of all graph edges, returning complete list. Each page request has built-in retry."""
    all_edges: list[Any] = []
    cursor: str | None = None
    page_num = 0
