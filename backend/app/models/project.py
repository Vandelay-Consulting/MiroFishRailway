...
For server-side persistence of project state, avoiding passing large amounts of data between frontend interfaces
"""
...
class ProjectStatus(str, Enum):
    ...
    ONTOLOGY_GENERATED = "ontology_generated"  # Ontology already generated
