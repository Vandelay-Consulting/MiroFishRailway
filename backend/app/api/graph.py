...
def generate_ontology():
    """
    Endpoint 1: Upload file and generate ontology definition
    ...
    try:
        ...
        logger.info(
            f"Ontology generation completed: {entity_count} entity types, {edge_count} relation types"
        )
        ...
        ProjectManager.save_project(project)
        logger.info(
            f"=== Ontology generation completed === Project ID: {project.project_id}"
        )
    ...
    try:
        ...
        if project.status == ProjectStatus.GRAPH_BUILDING and not force:
            return jsonify(
                {
                    "success": False,
                    "error": "Graph is being built, please do not submit duplicate requests. To force rebuild, add force: true",
