...
def generate_report():
    ...
    This is a time-consuming operation. The API immediately returns task_id,
    ...
    try:
        ...
        # Generate report_id in advance to return immediately
        import uuid
        ...
        return jsonify(
            {
                ...
                "data": {
                    ...
                    "task_id": task_id,
                    "status": "generating",
                    "message": "Report generation task started, check progress at /api/report/generate/status",
...
# ============== Report Progress & Section Interfaces ==============
...
def get_agent_log(report_id: str):
    ...
    Real-time access to every step during report generation, including:
...
def get_console_log(report_id: str):
    ...
    this is plain text console-style logs.
